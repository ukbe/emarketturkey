...
<ol>
    ...
    <li><?php echo link_to(__('Jobs<b></b>'), '@homepage', array('onmouseover' => "jQuery('#hrsub').show();jQuery(this).addClass('hover');", 'onmouseout' => "jQuery('#hrsub').hide();jQuery(this).removeClass('hover');", 'class' => 'selected')) ?>
        <div class="jssubmenu" id="hrsub" onmouseover="jQuery('#hrsub').show();jQuery(this).siblings('a').addClass('hoversec');" onmouseout="jQuery('#hrsub').hide();jQuery(this).siblings('a').removeClass('hoversec');">
            <ol>
                ...
                <li><?php echo link_to(__('Job Search'), '@homepage') ?></li>
            </ol></div></li>
