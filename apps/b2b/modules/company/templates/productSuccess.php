                ...
                <div class="box_576">
                    ...
                    <div>
                        ...
                        <dl class="_table _noInput">
                            ...
                            <dd><?php echo __('%1amount %2unit per %3period', array('%1amount' => $product->getCapacity(), '%2unit' => $product->getProductQuantityUnitRelatedByCapacityUnit(), '%3period' => $product->getTimePeriod()->__toString())) ?></dd>
