    ...
    <div class="col_576">
        ...
        <div class="box_576">
            ...
            <div class="_noBorder pad-0">
                ...
                <?php if ($act == 'new'): ?>
                <?php echo $objhandler->render($school, 'new') ?>
                <?php else:?>
                <div class="pad-1 margin-b2">
                <?php echo link_to(__('Add School'), "@mycv-action?action=education&act=new", 'id=addnew class=ln-addlink greenspan led add-11px ajax-enabled') ?>
                </div>
                <?php endif ?>

                <?php echo form_tag('@mycv-action?action=education') ?>
                <?php echo input_hidden_tag('done', __('Done')) ?>
                <?php echo input_hidden_tag('next', __('Next')) ?>
                <div class="txtCenter">
                    <?php echo link_to(__('Back'), '@mycv-action?action=contact', 'class=action-button _left')?>
