...
<div class="col_630">
    <div class="breadcrumb">
        <ul>
            <li><?php echo link_to(__('Knowledgebase Home'), "@kb") ?></li>
            <?php $parent = $category;
                  $html = "";
                  while (($parent = $parent->getParent()) && ($parent->getId() != $kb_category->getId()))
                    {
                        $html = "<li>".link_to($parent, "@kb-category?stripped_category={$parent->getStrippedCategory()}")."</li>". $html;
                    }
                  echo $html ? $html : ''; ?>
