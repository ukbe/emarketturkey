 ...
 * @sub-package login
 */
class eventsAction extends EmtGroupAction
{
    ...
    private function handleAction($isValidationError)
    {
        ...
        $c1 = $c->getNewCriterion(EventPeer::OWNER_ID, $this->group->getId());
        $c2 = $c->getNewCriterion(EventPeer::OWNER_TYPE_ID, PrivacyNodeTypePeer::PR_NTYP_GROUP);
        $c1->addAnd($c2);
        $c3 = $c->getNewCriterion(EventPeer::ORGANISER_ID, $this->group->getId());
        $c4 = $c->getNewCriterion(EventPeer::ORGANISER_TYPE_ID, PrivacyNodeTypePeer::PR_NTYP_GROUP);
        $c3->addAnd($c4);
        $c->addJoin(EventPeer::ID, EventInvitePeer::EVENT_ID, Criteria::LEFT_JOIN);
        $c5 = $c->getNewCriterion(EventInvitePeer::SUBJECT_ID, $this->group->getId());
        $c6 = $c->getNewCriterion(EventInvitePeer::SUBJECT_TYPE_ID, PrivacyNodeTypePeer::PR_NTYP_GROUP);
        $c5->addAnd($c6);
