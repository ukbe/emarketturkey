...
<?php include_partial('venues') ?>
    ...
    <div class="col_576">
        <div class="box_576 _titleBG_Transparent">
            <section>
            <h4 style="border-bottom:none;"><?php echo __('Browse Venues by Country') ?></h4>
            <?php $initial = '' ?>
            ...
            <?php foreach ($countries as $country): ?>
                ...
                <?php endif ?>
                <li><?php echo link_to($country->getName(), "@venues-dir?substitute={$country->getStrippedName()}")?></li>
            <?php endforeach ?>
            </ul>
