...
<?php include_partial('people') ?>
    ...
    <div class="col_576">
        <div class="box_576 _titleBG_Transparent">
            <section>
            <h4 style="border-bottom:none;"><?php echo __('Browse People by Country') ?></h4>
            <?php $initial = '' ?>
            ...
            <?php foreach ($countries as $country): ?>
                ...
                <?php endif ?>
                <li><?php echo link_to($country->getName(), "@people-dir?substitute={$country->getStrippedName()}")?></li>
            <?php endforeach ?>
            </ul>
