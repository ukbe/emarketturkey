...
<?php include_partial('products') ?>
    ...
    <div class="col_576">
        <div class="box_576 _titleBG_Transparent">
            <section>
            <h4 style="border-bottom:none;"><?php echo __('Browse Products by Country') ?></h4>
            <?php $initial = '' ?>
            ...
            <?php foreach ($countries as $country): ?>
                ...
                <?php endif ?>
                <li><?php echo link_to($country->getName(), "@products-dir?substitute={$country->getStrippedName()}")?></li>
            <?php endforeach ?>
            </ul>
