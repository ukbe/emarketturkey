...
<div class="col_948">
    ...
    <?php if ($company->getLogo()): ?>
        <div class="box_180 txtCenter">
            <?php echo link_to(image_tag($company->getLogo()->getMediumUri()), "@company-jobs?hash={$company->getHash()}") ?>
        </div>
    <?php endif ?>
        <div class="box_180 txtCenter">
...
<?php include_partial('leftmenu_company', array('company' => $company, 'sesuser' => $sesuser))?>
    </div>
