...
<div class="col_948">
    ...
    <div class="col_657 clear _center">
        <div class="box_657">
            ...
            <?php echo __('Your Translator Account application was successfully received. We will evaluate your application and take necessary steps very soon.') ?>
            <div class="hrsplit-3"></div>
            <b><?php echo __('Applied as: <span class="t_green">%1</span>', array('%1' => $account)) ?></b>
            <div class="hrsplit-3"></div>
            <ul class="sepdot">
                <li><?php echo link_to(__('Go to Translation Homepage'), '@homepage', 'class=bluelink hover') ?></li>
