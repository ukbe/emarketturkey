...
<?php include_partial('tradeexperts') ?>
    ...
    <div class="col_576">
        <div class="box_576 _titleBG_Transparent">
            <section>
            <h4 style="border-bottom:none;"><?php echo __('Browse Trade Experts by Industry') ?></h4>
            <?php $initial = '' ?>
            ...
            <?php foreach ($industries as $industry): ?>
                ...
                <?php endif ?>
                <li><?php echo link_to($industry, "@tradeexperts-dir?substitute={$industry->getStrippedName()}")?></li>
            <?php endforeach ?>
            </ul>
