    ...
    <div class="box_312 _border_Shadowed">
        ...
        <div>
            ...
            <div class="col_authors margin-t2">
                <dl>
                    <dt><?php echo count($source->getPhotos()) ? link_to(image_tag($source->getPictureUri(), array('title' => $source->__toString())), $source->getUrl(PublicationPeer::PUB_TYP_NEWS)) : '' ?></dt>
                    <dd>
                        <div class="author-name"><?php echo link_to($source->__toString(), $source->getUrl(PublicationPeer::PUB_TYP_NEWS)) ?></div>
