...
class articleAction extends EmtAction
{
    ...
    public function execute($request)
    {
        ...
        if ($this->article->getPublicationSource()) $this->getResponse()->addObjectMeta(array('name' => 'source', 'itemprop' => 'sourceOrganization'), $this->article->getPublicationSource()->__toString());
        ...
        if ($this->article->getPicture()) $this->getResponse()->addObjectMeta(array('itemprop' => 'thumbnailUrl'), url_for($this->article->getPicture()->getThumbnailUri(), true));
