...
<?php include_partial('events') ?>
    ...
    <div class="col_576">
        <div class="box_576 _titleBG_Transparent">
            <h4 style="border-bottom:none;"><?php echo __('Find a Trade Show') ?></h4>
            ...
            <dl class="_table">
                ...
                <?php  /* This section will be enabled after adding support for industry property for trade events
        ...
        <div class="box_576">
            <h5 class="margin-0"><?php echo __('Featured Trade Shows') ?></h5>
            <div class="_noBorder">
                <?php include_partial('layout_extended_event', array('results' => $featured_shows)) ?>
                <?php echo link_to(__('List all Featured Trade Shows'), "@events-action?action=featured", 'class=clear inherit-font hover bluelink margin-t1') ?>
            </div>
        </div>
