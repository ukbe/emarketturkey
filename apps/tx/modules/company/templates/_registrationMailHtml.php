    ...
    <tr>
        <td colspan="2" align="left" valign="top">
            <p style="margin: 20px; font-family: Arial; font-size: 10pt">
                ...
                <?php echo link_to('', "@myemt.company-manage?hash={$company->getHash()}", array('absolute_url' => true)) ?><br /><br />
                <?php echo __("If you wish to add your company's products or services, visit the link below :") ?><br />
                <?php echo link_to('', "@myemt.products-overview?hash={$company->getHash()}", array('absolute_url' => true)) ?><br /><br />
