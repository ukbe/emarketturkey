...
<ol>
    ...
    <li><?php echo link_to(__('Community'), '@homepage', array('onmouseover' => "jQuery('#cmsub').show();jQuery(this).addClass('hover');", 'onmouseout' => "jQuery('#cmsub').hide();jQuery(this).removeClass('hover');", 'class' => 'selected')) ?>
