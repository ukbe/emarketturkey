        ...
        <dl>
            ...
            <dd id='btn-ac-box'>
                <ul>
                    ...
                    <li><?php echo link_to(__('Knowledgebase'), '@ac.homepage') ?></li>
                </ul>
            </dd>
        </dl>
        <dl>
            <dt>
                <a href="<?php echo url_for('@homepage') ?>" tabindex="5" id="btn-cm"><b><?php echo __('COMMUNITY') ?></b></a>
            </dt>
            <dd id='btn-cm-box'>
                <ul>
        ...
        <dl>
            ...
            <dd id='btn-tx-box'>
                <ul>
                    <li><?php echo link_to(__('People'), '@people') ?></li>
                    <li><?php echo link_to(__('Groups'), '@groups') ?></li>
                    <li><?php echo link_to(__('Events'), '@homepage') ?></li>
                    <li><?php echo link_to(__('Public Bulletin'), '@homepage') ?></li>
                </ul>
            </dd>
        </dl>
        <ul id="buttons">
            ...
            <li><b><?php echo link_to(__('Contacts').'<b></b>', '@network', array('id' => 'btn_contacts', 'title' => __('Contacts'))) ?></b></li>
...
<?php $search = array(PrivacyNodeTypePeer::PR_NTYP_COMPANY  => array(__('Companies'), url_for('@companies')),
                      ...
                      PrivacyNodeTypePeer::PR_NTYP_JOB     => array(__('Jobs'), url_for('@people'))) ?>
