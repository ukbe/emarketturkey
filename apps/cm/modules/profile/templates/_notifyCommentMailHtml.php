    ...
    <tr>
        <td colspan="2" align="left" valign="top">
            <p style="margin: 20px; font-family: Arial; font-size: 10pt">
                ...
                <?php echo __('%1 commented on %2.', array('%1' => $uname, '%2' => $declaration)) ?><br /><br />
                <?php if ($comment!=''): ?>
                <b><?php echo __('Comment:') ?></b><br />
                <?php echo $comment ?><br /><br />
                <?php endif ?>
                <?php echo __('You can click the link below to view the comment:') ?><br/>
                <?php echo link_to('', $link, array('absolute_url' => true)); ?>
                <br /><br />
