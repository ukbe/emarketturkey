...
<?php slot('mappath') ?>
<?php include_partial('profile/user_pagetop', array('map' => array(__('My Profile') => $user->getProfileUrl(),
                                                                   __('Edit') => null
                                                                   )
...
<li class="column span-100"><h2><?php echo __('General Information') ?></h2></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_hometown_country', __('Home Country')) ?></li>
...
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_hometown_state', __('Hometown')) ?></li>
<li class="column span-70"><div id="hometown_city_div"><?php echo select_tag('profile_hometown_state', options_for_select($local_cities, $profile->getHomeTownId(), array('include_custom' => __('select city')))) ?></div></li>
...
<li class="column span-70 "><?php echo select_day_tag('profile_bd_day', $sf_params->get('profile_bd_day', $user->getBirthdate('d')), array('include_custom' => __('day'))) . '&nbsp;' . select_month_tag('profile_bd_month', $sf_params->get('profile_bd_month', $user->getBirthdate('m')), array('include_custom' => __('month'))) . '&nbsp;' . select_year_tag('profile_bd_year', $sf_params->get('profile_bd_year', $user->getBirthdate('Y')), array('year_start' => date('Y')-90, 'year_end' => date('Y')-10, 'include_custom' => __('year'))) ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_marital_stat', __('Marital Status')) ?></li>
<li class="column span-70"><?php echo select_tag('profile_marital_stat', options_for_select(
    array(UserProfilePeer::MAR_STAT_NA         => __('Not Set'),
          UserProfilePeer::MAR_STAT_SINGLE      => __('Single'),
          UserProfilePeer::MAR_STAT_MARRIED     => __('Married')), $profile?$profile->getMaritalStatus():null)) ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_gender', __('Gender')) ?></li>
...
<li class="column span-94 prepend-6"><b><?php echo __('Home Contact Information') ?> :</b></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_home_phone', __('Phone')) ?></li>
<li class="column span-70"><?php echo input_tag('profile_home_phone', $home_phone->getPhone(), 'size=20') ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_home_street', __('Street Address')) ?></li>
<li class="column span-70"><?php echo input_tag('profile_home_street', $home_address->getStreet(), 'size=50') ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_home_state', __('State/Province')) ?></li>
<li class="column span-70"><div id="profile_home_state_div"><?php echo select_tag('profile_home_state', options_for_select($contact_cities, $home_address->getState(), array('include_custom' => __('select state/province')))) ?></div></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_home_city', __('City/Town')) ?></li>
...
<li class="column span-94 prepend-6"><b><?php echo __('Work Contact Information') ?> :</b></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_work_phone', __('Phone')) ?></li>
<li class="column span-70"><?php echo input_tag('profile_work_phone', $work_phone->getPhone(), 'size=20') ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_work_street', __('Street Address')) ?></li>
<li class="column span-70"><?php echo input_tag('profile_work_street', $work_address->getStreet(), 'size=50') ?></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_work_state', __('State/Province')) ?></li>
<li class="column span-70"><div id="profile_work_state_div"><?php echo select_tag('profile_work_state', options_for_select($contact_cities, $work_address->getState(), array('include_custom' => __('select state/province')))) ?></div></li>
<li class="column span-28 append-2 right"><?php echo emt_label_for('profile_work_city', __('City/Town')) ?></li>
