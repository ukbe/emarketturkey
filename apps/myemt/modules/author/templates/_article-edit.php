...
<dl class="_table ln-part _wideInput">
    ...
    <dd><?php echo select_language_tag("article_lang_$key", $lang, array('languages' => sfConfig('app_i18n_cultures'), 'class' => 'ln-select', 'name' => 'article_lang[]', 'include_blank' => true)) ?>
...
<div class="txtCenter">
    ...
    <?php echo link_to(__('Cancel'), ($object->isNew() ? "@author-action?action=articles" : $object->getEditUrl('view')).(($filter = $sf_params->get('filter')) ? "&filter=$filter" : ''), 'class=inherit-font bluelink hover') ?></span>
</div>
</form>
<div class="hrsplit-3"></div>
</div>
