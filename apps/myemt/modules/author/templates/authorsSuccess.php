    ...
    <div class="col_576">
        <div class="box_576">
            <div class="_noBorder">
                ...
                <div class="_left margin-b2"><?php echo link_to(__('Add Author'), "@author-action?action=author&act=new", 'class=greenspan led add-11px')?></div>
                <div class="clear">
                    <?php include_partial("layout_authors", array('pager' => $pager, 'sort' => $sort, 'dir' => $dir)) ?>
                </div>
