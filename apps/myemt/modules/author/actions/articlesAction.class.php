 ...
 * @sub-package login
 */
class articlesAction extends EmtAuthorAction
{
    ...
    private function handleAction($isValidationError)
    {
        ...
        if (!$this->filter)
            $this->pager = $this->author->getPublicationPager($this->page, $this->ipp, $c, PublicationPeer::PUB_TYP_ARTICLE);
        else
            $this->pager = PublicationPeer::getPager($this->page, $this->ipp, $c, null, PublicationPeer::PUB_TYP_ARTICLE);
