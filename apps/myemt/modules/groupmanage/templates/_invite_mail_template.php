...
<div>
    <div style="float: left; width: 420px; text-align: left; padding-left: 30px; padding-top: 20px;">
        ...
        <p><?php echo __('You are invited to join the group <b>"%1"</b> by <b>%2</b>.', array('%1' => $gname, '%2' => $mnamelname)) ?></p>
        <?php if ($message): ?>
        <p><?php echo __('Here is %1 message :', array('%1' => ($gender==UserProfilePeer::GENDER_FEMALE?__('her'):__('his')))) ?></p>
        <p>"<?php echo $message ?>"</p>
        <?php endif ?>
        <p><?php echo __("You may click the link below to respond to your invitation to join the group:") ?></p>
        <p><?php echo link_to('', '@lobby.signup?sf_culture='.$culture, array('query_string' => 'invite='. $invite_guid, 'absolute' => true)) ?></p>
    </div>
