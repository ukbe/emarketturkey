...
<td>
    <?php echo link_to(__('Tasks'), '@tasks', 'class=toplink') ?>
</td>
<?php endif ?>
<td class="island">
    ...
    <div id="hover-account" class="top-submenu first">
        ...
        <li><?php echo link_to(__('Account Settings'), '@account') ?></li>
        <li><?php echo link_to(__('Privacy Settings'), '@setup-privacy') ?></li>
...
<td>
    ...
    <div>
        ...
        <li style="text-align: right"><em><?php echo link_to(__('Forgot Password?'), '@forgot-password') ?></em></li>
        </ol>
        <?php echo "</form>" ?>
        </div>
    </div>
...
<td>
    <?php echo !$sf_user->getUser()?link_to(__('Sign Up'), '@signup', 'class=toplink')."&nbsp;":"" ?>
</td>
<?php endif ?>
<td class="island">
