...
<div class="col_948">
    ...
    <div class="premium-container">
        <span class="p-header"><?php echo __('Select a Premium Membership to upgrade your account') ?></span>
        <div class="p-border">
        <div class="p-box gold">
            ...
            <div class="hrsplit-3"></div>
            <?php echo link_to(__('Upgrade to Gold Account'), "@homepage", 'class=green-button') ?>
        ...
        <div class="p-box platinum">
            ...
            <div class="hrsplit-3"></div>
            <?php echo link_to(__('Upgrade to Platinum Account'), "@homepage", 'class=green-button') ?>
            <div class="p-compare gold<?php echo $sf_params->get('act') == 'compare' ? '' : ' ghost' ?>">
                <ul>
                <li><span><?php echo __('emtTrust') ?><sup>®</sup></span><?php echo __('Verified business with emtTrust') ?><sup>®</sup></li>
