    ...
    <div id="lsi_<?php echo $culture ?>"<?php echo $active?'':' style="display: none;"' ?>>
        <ol class="column span-120" style="padding: 0px;margin: 0px;">
            <li class="column span-26 right"><?php echo emt_label_for('jobposition_name_'.$culture, __('Job Position Name')) ?></li>
            <li class="column span-92 prepend-2"><?php echo input_tag('jobposition_name_'.$culture, $sf_params->get('jobposition_name_'.$culture, $jobPosition->getName($culture)), 'size=50') ?></li>
        </ol>
    </div></li>