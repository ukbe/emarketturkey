...
<dl class="_table ln-part">
    ...
    <dd><?php echo select_language_tag("lead_lang_$key", $lang, array('languages' => sfConfig::get('app_i18n_cultures'), 'class' => 'ln-select', 'name' => 'lead_lang[]', 'include_blank' => true)) ?></dd>
    <dt></dt>
