...
<li><?php echo link_to(__('Send Message'), 'messages/compose', array('query_string' => 'rcpu='.$user->getId()."&_ref=$_here")) ?></li>
<?php endif ?>
<?php if (!$sf_user->getUser()->isFriendsWith($user->getId())): ?>
<li><?php echo link_to(__('Add to My Network'), 'network/add', array('query_string' => 'cid='.$user->getId())) ?></li>
<?php endif ?>
</ol>
