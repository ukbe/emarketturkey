...
<?php echo $sf_user->getFlash('message') ?>
    <div class="col_576">
            <section>
                <h4><?php echo __('Company Logo') ?></h4>
                <div class="_center">
                    <br class="clear" />
                    <table style="margin: 0px; width: 100%; border: solid 2px #ddd; background-color: #F6F6F6;">
                        <tr>
                            ...
                            <td style="background-color: #EFEFEF; vertical-align: middle; text-align: center;">
                                ...
                                <?php echo form_tag("@upload-company-logo?hash={$company->getHash()}") ?>
                    ...
                    <div class="clear">
                        ...
                        <div class="panes">
                            <div class="pad-2">
                                <?php echo form_tag("@upload-company-logo?hash={$company->getHash()}", array('enctype' => 'multipart/form-data', 'id' => 'thumbform')) ?>
                                <div class="error-block"></div>
                                <dl class="_table">
                                <dt class="frm-st-select"><?php echo emt_label_for('companylogo', 'Please select a file') ?></dt>
                                <dd class="frm-st-select"><?php echo input_file_tag('companylogo') ?></dd>
                            ...
                            <div class="pad-2">
                                <?php $images = $company->getMediaItems() ?>
                                <?php if (count($images)): ?>
                                <ul id="gallery">
