    ...
    <div id="lsi_<?php echo $culture ?>"<?php echo (in_array($culture, $sf_params->get('languages', array())) || $profile->hasLsiIn($culture))?'':' style="display: none;"' ?>>
        <ol class="column span-110" style="padding: 0px;margin: 0px;">
            ...
            <li class="column span-72 prepend-2"><?php echo textarea_tag('introduction_'.$culture, $sf_params->get('introduction_'.$culture, $profile->getIntroduction($culture)), 'cols=52 rows=4 maxlength=2000') ?></li>
            <li class="column span-36 right"><?php echo emt_label_for('productservice_'.$culture, __('Products and Services')) ?></li>
            <li class="column span-72 prepend-2"><?php echo textarea_tag('productservice_'.$culture, $sf_params->get('productservice_'.$culture, $profile->getProductService($culture)), 'cols=52 rows=4 maxlength=2000') ?></li>
        </ol>
    </div></li>