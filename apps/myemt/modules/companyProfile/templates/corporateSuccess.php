...
<dl class="_table ln-part">
    ...
    <dd><?php echo select_language_tag("comp_lang_$key", $lang, array('languages' => sfConfig::get('app_i18n_cultures'), 'class' => 'ln-select', 'name' => 'comp_lang[]', 'include_blank' => true)) ?></dd>
    <dt></dt>
    ...
    <dd><?php echo textarea_tag("introduction_$key", $sf_params->get("introduction_$key", $profile->getClob(CompanyProfileI18nPeer::INTRODUCTION, $lang)), 'cols=52 rows=4 maxlength=5000') ?></dd>
    <dt><?php echo emt_label_for("productservice_$key", __('Products and Services')) ?></dt>
    <dd><?php echo textarea_tag("productservice_$key", $sf_params->get("productservice_$key", $profile->getClob(CompanyProfileI18nPeer::PRODUCT_SERVICE, $lang)), 'cols=52 rows=4 maxlength=5000') ?></dd>
</dl>
<?php endforeach ?>
<dl class="_table">
    <dt></dt>
