...
<?php echo $person ?><br />
<?php endif ?>
<?php if ($sesuser->can(ActionPeer::ACT_SEND_MESSAGE, $person)) echo link_to(__('Send Message'), '@myemt.compose-message', array('query_string' => 'rcpu='.$person->getId().'&rcptyp='.PrivacyNodeTypePeer::PR_NTYP_USER."&_ref=$_here", 'class' => 'action')) ?>
</td>
<td width="115">
...
<?php echo $group ?><br />
<?php endif ?>
<?php if ($sesuser->can(ActionPeer::ACT_SEND_MESSAGE, $group)) echo link_to(__('Send Message'), '@myemt.compose-message', array('query_string' => 'rcpu='.$group->getId().'&rcptyp='.PrivacyNodeTypePeer::PR_NTYP_GROUP."&_ref=$_here", 'class' => 'action')) ?>
</td>
<td width="115">
...
<?php echo $company ?><br />
<?php endif ?>
<?php if ($sesuser->can(ActionPeer::ACT_SEND_MESSAGE, $company)) echo link_to(__('Send Message'), '@myemt.compose-message', array('query_string' => 'rcpu='.$company->getId().'&rcptyp='.PrivacyNodeTypePeer::PR_NTYP_COMPANY."&_ref=$_here", 'class' => 'action')) ?>
</td>
<td width="115">
