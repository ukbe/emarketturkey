...
<?php echo $company ?><br />
<?php endif ?>
<?php if ($sesuser->can(ActionPeer::ACT_SEND_MESSAGE, $company)) echo link_to(__('Send Message'), '@myemt.compose-message', array('query_string' => 'rcpu='.$company->getId().'&rcptyp='.PrivacyNodeTypePeer::PR_NTYP_COMPANY."&ref=$_here", 'class' => 'action')) ?>
</td>
<?php if ($i % 3 == 0): ?>
</tr>
<?php endif ?>
