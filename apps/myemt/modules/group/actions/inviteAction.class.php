...
class inviteAction extends EmtGroupAction
{
    ...
    public function handleAction($isValidationError)
    {
        ...
        if ($this->getRequest()->getMethod() == sfRequest::POST && !$isValidationError)
        {
            ...
            catch(Exception $e)
            {
                ...
                ErrorLogPeer::Log($this->group->getId(), PrivacyNodeTypePeer::PR_NTYP_GROUP, "Error occured while inviting user's friends to group.", $e);
            }
        }
    }
