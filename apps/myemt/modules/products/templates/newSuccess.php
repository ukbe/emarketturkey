...
<dl class="_table">
    ...
    <dd><?php echo select_tag('product_brand_owner', options_for_select(CompanyBrandPeer::$typeNames, $sf_params->get('product_brand_owner', $product->getBrandName() ? CompanyBrandPeer::BRND_HOLDED_BY_ELSE : ($product->getBrandId() ? CompanyBrandPeer::BRND_HOLDED_BY_COMPANY : CompanyBrandPeer::BRND_NONE)), array('use_i18n' => true))) ?>
    ...
    <dd><?php echo checkbox_tag('product_active', 'online', $product->isNew() ? 1 : $product->getActive()) ?>
...
<dl class="_table ln-part">
    ...
    <dd><?php echo select_language_tag("product_lang_$key", $lang, array('languages' => sfConfig::get('app_i18n_cultures'), 'class' => 'ln-select', 'name' => 'product_lang[]', 'include_blank' => true)) ?>
