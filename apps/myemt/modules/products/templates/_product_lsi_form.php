    ...
    <div id="lsi_<?php echo $culture ?>"<?php echo (in_array($culture, $sf_params->get('languages', array())) || $product->hasLsiIn($culture))?'':' style="display: none;"' ?>>
        <ol class="column span-100" style="padding: 0px;margin: 0px;">
            ...
            <li class="column span-72 prepend-2"><?php echo textarea_tag('product_introduction_'.$culture, $sf_params->get('product_introduction_'.$culture, $product->getClob(ProductI18nPeer::INTRODUCTION, $culture)), 'cols=52 rows=4 maxlength=1800') ?></li>
