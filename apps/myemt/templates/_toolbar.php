...
<div id="mainmenu">
<ol>
    <li><?php echo link_to(__('Home'), $sf_user->getUser() ? '@homepage' : '@lobby.homepage', array('onmouseover' => "jQuery('#myemtsub').show();".($sf_user->getUser() ? "jQuery(this).addClass('hover');" : ""), 'onmouseout' => "jQuery('#myemtsub').hide();".($sf_user->getUser() ? "jQuery(this).removeClass('hover');" : ""))) ?>
