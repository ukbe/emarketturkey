...
<ol>
    ...
    <li><?php echo link_to(__('Academy'), '@homepage', array('onmouseover' => "jQuery('#acsub').show();jQuery(this).addClass('hover');", 'onmouseout' => "jQuery('#acsub').hide();jQuery(this).removeClass('hover');", 'class' => 'selected')) ?>
