...
ALTER TABLE "EMT_TRANSLATOR_LANGUAGE" ADD CONSTRAINT "EMT_TRANSLATOR_LANGUAGE_FK_1" FOREIGN KEY ("ID") REFERENCES "EMT_TRANSLATOR" ("ID") ON DELETE CASCADE;
...
ALTER TABLE "EMT_TRANSLATOR_COUPLE" ADD CONSTRAINT "EMT_TRANSLATOR_COUPLE_FK_1" FOREIGN KEY ("ID") REFERENCES "EMT_TRANSLATOR" ("ID") ON DELETE CASCADE;
