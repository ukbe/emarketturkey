...
ALTER TABLE "EMT_PREMIUM_ACCOUNT" ADD CONSTRAINT "EMT_PREMIUM_ACCOUNT_FK_1" FOREIGN KEY ("OWNER_TYPE_ID") REFERENCES "EMT_PRIVACY_NODE_TYPE" ("ID") ON DELETE NO ACTION;


/* EMT_FAQ_CATEGORY-------------------------------------------------- */

DROP TABLE "EMT_FAQ_CATEGORY" CASCADE CONSTRAINTS;

DROP SEQUENCE "EMT_FAQ_CATEGORY_SEQ";


CREATE TABLE "EMT_FAQ_CATEGORY"
(
	"ID" NUMBER(16)  NOT NULL,
	"PARENT_ID" NUMBER(16)
);

	ALTER TABLE "EMT_FAQ_CATEGORY"
		ADD CONSTRAINT "EMT_FAQ_CATEGORY_PK"
	PRIMARY KEY ("ID");
CREATE SEQUENCE "EMT_FAQ_CATEGORY_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;

ALTER TABLE "EMT_FAQ_CATEGORY" ADD CONSTRAINT "EMT_FAQ_CATEGORY_FK_1" FOREIGN KEY ("PARENT_ID") REFERENCES "EMT_FAQ_CATEGORY" ("ID") ON DELETE CASCADE;


/* EMT_FAQ_CATEGORY_I18N-------------------------------------------------- */

DROP TABLE "EMT_FAQ_CATEGORY_I18N" CASCADE CONSTRAINTS;


CREATE TABLE "EMT_FAQ_CATEGORY_I18N"
(
	"ID" NUMBER(16)  NOT NULL,
	"CULTURE" NVARCHAR2(7)  NOT NULL,
	"NAME" NVARCHAR2(100)  NOT NULL
	...
	ALTER TABLE "EMT_FAQ_CATEGORY_I18N"
		ADD CONSTRAINT "EMT_FAQ_CATEGORY_I18N_PK"
	PRIMARY KEY ("ID","CULTURE");

ALTER TABLE "EMT_FAQ_CATEGORY_I18N" ADD CONSTRAINT "EMT_FAQ_CATEGORY_I18N_FK_1" FOREIGN KEY ("ID") REFERENCES "EMT_FAQ_CATEGORY" ("ID") ON DELETE CASCADE;


/* EMT_FAQ_ITEM-------------------------------------------------- */

DROP TABLE "EMT_FAQ_ITEM" CASCADE CONSTRAINTS;

DROP SEQUENCE "EMT_FAQ_ITEM_SEQ";


CREATE TABLE "EMT_FAQ_ITEM"
(
	"ID" NUMBER(10)  NOT NULL,
	"CATEGORY_ID" NUMBER(10)  NOT NULL
);

	ALTER TABLE "EMT_FAQ_ITEM"
		ADD CONSTRAINT "EMT_FAQ_ITEM_PK"
	PRIMARY KEY ("ID");
CREATE SEQUENCE "EMT_FAQ_ITEM_SEQ" INCREMENT BY 1 START WITH 1 NOMAXVALUE NOCYCLE NOCACHE ORDER;

ALTER TABLE "EMT_FAQ_ITEM" ADD CONSTRAINT "EMT_FAQ_ITEM_FK_1" FOREIGN KEY ("CATEGORY_ID") REFERENCES "EMT_FAQ_CATEGORY" ("ID") ON DELETE NO ACTION;


/* EMT_FAQ_ITEM_I18N-------------------------------------------------- */

DROP TABLE "EMT_FAQ_ITEM_I18N" CASCADE CONSTRAINTS;


CREATE TABLE "EMT_FAQ_ITEM_I18N"
(
	"ID" NUMBER(10)  NOT NULL,
	"CULTURE" NVARCHAR2(7)  NOT NULL,
	...
	ALTER TABLE "EMT_FAQ_ITEM_I18N"
		ADD CONSTRAINT "EMT_FAQ_ITEM_I18N_PK"
	PRIMARY KEY ("ID","CULTURE");

ALTER TABLE "EMT_FAQ_ITEM_I18N" ADD CONSTRAINT "EMT_FAQ_ITEM_I18N_FK_1" FOREIGN KEY ("ID") REFERENCES "EMT_FAQ_ITEM" ("ID") ON DELETE CASCADE;
