...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\EMT.workspace\\geek\\log/myemt_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\EMT.workspace\\geek\\cache\\myemt\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\EMT.workspace\\geek\\apps\\myemt/i18n',
));
  ...
  'database' => 'oci8://geek:geeker@emtbag',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'swPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\EMT.workspace\\geek\\cache\\myemt\\dev\\config/routing',
  'lifetime' => 31556926,
  'prefix' => 'C:\\EMT.workspace\\geek\\apps\\myemt/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('emthook'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'emthook',
  'session_cookie_domain' => '.geek.emt',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\EMT.workspace\\geek\\cache\\myemt\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\EMT.workspace\\geek\\apps\\myemt/template',
)));
