...
global $fonts_dir, $images_dir;
$fonts_dir = sfConfig::get('app_cryptographp_fontsdir', $current_dir.'fonts/');
$images_dir = sfConfig::get('app_cryptographp_imagesdir', $current_dir.'images/');

// globals for ecriture()
global $img, $ink, $charR, $charG, $charB, $charclear, $xvariation, $charnb, $charcolorrnd, $charcolorrndlevel, $tword, $charspace;
// glovals for noisecolor()
global $noisecolorchar, $bg, $brushsize;
// globals for bruit()
...
//    readfile($images_dir.'erreur3.png'); 
//    exit;
//    }
...
if ($_SESSION['cryptcptuse']>=$cryptusemax) {
   ...
   readfile($images_dir.'erreur1.png');
   exit;
   }
...
if ($delai < $cryptusetimer) { 
   switch ($cryptusertimererror) {
          case 2  : header("Content-type: image/png");
                    ...
                    readfile($images_dir.'erreur2.png');
                    exit;
