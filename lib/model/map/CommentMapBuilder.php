...
/**
 * This class adds structure of 'EMT_COMMENT' table to 'propel' DatabaseMap object.
 *
 *
...
class CommentMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->setPrimaryKeyMethodInfo('EMT_COMMENT_SEQ');

		$tMap->addPrimaryKey('ID', 'Id', 'INTEGER', true, 10);

		$tMap->addColumn('ITEM_ID', 'ItemId', 'INTEGER', false, 10);

		$tMap->addForeignKey('ITEM_TYPE_ID', 'ItemTypeId', 'INTEGER', 'EMT_PRIVACY_NODE_TYPE', 'ID', true, 3);

		$tMap->addColumn('COMMENTER_ID', 'CommenterId', 'INTEGER', false, 10);

		$tMap->addForeignKey('COMMENTER_TYPE_ID', 'CommenterTypeId', 'INTEGER', 'EMT_PRIVACY_NODE_TYPE', 'ID', true, 3);

		$tMap->addColumn('TEXT', 'Text', 'VARCHAR', false, 2000);
