...
/**
 * Base static class for performing query and update operations on the 'EMT_PRODUCT_I18N' table.
 *
 * 
 *
...
abstract class BaseProductI18nPeer {
	...
	const TABLE_NAME = 'EMT_PRODUCT_I18N';
	...
	const ID = 'EMT_PRODUCT_I18N.ID';

	/** the column name for the CULTURE field */
	const CULTURE = 'EMT_PRODUCT_I18N.CULTURE';

	/** the column name for the NAME field */
	const NAME = 'EMT_PRODUCT_I18N.NAME';

	/** the column name for the INTRODUCTION field */
	const INTRODUCTION = 'EMT_PRODUCT_I18N.INTRODUCTION';

	/** the column name for the PACKAGING field */
	const PACKAGING = 'EMT_PRODUCT_I18N.PACKAGING';

	/** the column name for the HTML_CONTENT field */
	const HTML_CONTENT = 'EMT_PRODUCT_I18N.HTML_CONTENT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Culture', 'Name', 'Introduction', 'Packaging', 'HtmlContent', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'culture', 'name', 'introduction', 'packaging', 'htmlContent', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CULTURE, self::NAME, self::INTRODUCTION, self::PACKAGING, self::HTML_CONTENT, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'CULTURE', 'NAME', 'INTRODUCTION', 'PACKAGING', 'HTML_CONTENT', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Culture' => 1, 'Name' => 2, 'Introduction' => 3, 'Packaging' => 4, 'HtmlContent' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'culture' => 1, 'name' => 2, 'introduction' => 3, 'packaging' => 4, 'htmlContent' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CULTURE => 1, self::NAME => 2, self::INTRODUCTION => 3, self::PACKAGING => 4, self::HTML_CONTENT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'CULTURE' => 1, 'NAME' => 2, 'INTRODUCTION' => 3, 'PACKAGING' => 4, 'HTML_CONTENT' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ProductI18nPeer::INTRODUCTION);

		$criteria->addSelectColumn(ProductI18nPeer::PACKAGING);

		$criteria->addSelectColumn(ProductI18nPeer::HTML_CONTENT);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_PRODUCT_I18N table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
