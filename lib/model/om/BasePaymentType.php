...
/**
 * Base class that represents a row from the 'EMT_PAYMENT_TYPE' table.
 *
 * 
 *
...
abstract class BasePaymentType extends BaseObject  implements Persistent {
  ...
  const PEER = 'PaymentTypePeer';
	...
	/**
	 * @var        array PaymentTypeI18n[] Collection to store aggregation of PaymentTypeI18n objects.
	 */
	protected $collPaymentTypeI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPaymentTypeI18ns.
	 */
	private $lastPaymentTypeI18nCriteria = null;
  ...
  protected $culture;
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collPaymentTypeI18ns = null;
			$this->lastPaymentTypeI18nCriteria = null;
	...
	/**
	 * Clears out the collPaymentTypeI18ns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addPaymentTypeI18ns()
	 */
	public function clearPaymentTypeI18ns()
	{
		$this->collPaymentTypeI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collPaymentTypeI18ns collection (array).
	 *
	 * By default this just sets the collPaymentTypeI18ns collection to an empty array (like clearcollPaymentTypeI18ns());
	...
	/**
	 * Gets an array of PaymentTypeI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this PaymentType has previously been saved, it will retrieve
	 * related PaymentTypeI18ns from storage. If this PaymentType is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array PaymentTypeI18n[]
	 * @throws     PropelException
	 */
	public function getPaymentTypeI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PaymentTypePeer::DATABASE_NAME);
		}
	...
	/**
	 * Returns the number of related PaymentTypeI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related PaymentTypeI18n objects.
	 * @throws     PropelException
	 */
	public function countPaymentTypeI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PaymentTypePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collPaymentTypeI18ns === null) {
			if ($this->isNew()) {
				...
				$count = PaymentTypeI18nPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPaymentTypeI18nCriteria) || !$this->lastPaymentTypeI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collPaymentTypeI18ns);
				}
			} else {
				$count = count($this->collPaymentTypeI18ns);
			}
	...
	{
		if ($this->collPaymentTypeI18ns === null) {
			$this->initPaymentTypeI18ns();
		}
		if (!in_array($l, $this->collPaymentTypeI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPaymentTypeI18ns, $l);
	...
	{
		if ($deep) {
			if ($this->collPaymentTypeI18ns) {
				foreach ((array) $this->collPaymentTypeI18ns as $o) {
  ...
  {
    return $this->getCurrentPaymentTypeI18n($culture)->getName();
  }

  public function setName($value, $culture = null)
  {
    $this->getCurrentPaymentTypeI18n($culture)->setName($value);
  }

  protected $current_i18n = array();

  public function getCurrentPaymentTypeI18n($culture = null)
  {
    if (is_null($culture))
    {
    ...
    {
      $obj = PaymentTypeI18nPeer::retrieveByPK($this->getId(), $culture);
      if ($obj)
      {
        $this->setPaymentTypeI18nForCulture($obj, $culture);
      }
      else
      {
        $this->setPaymentTypeI18nForCulture(new PaymentTypeI18n(), $culture);
