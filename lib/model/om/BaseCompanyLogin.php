...
/**
 * Base class that represents a row from the 'EMT_COMPANY_LOGIN' table.
 *
 * 
 *
 ...
 */
abstract class BaseCompanyLogin extends BaseObject  implements Persistent {


  const PEER = 'CompanyLoginPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CompanyLoginPeer
	 */
	...
	/**
	 * Initializes internal state of BaseCompanyLogin object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     CompanyLogin The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CompanyLoginPeer::ID;
		}
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = CompanyLoginPeer::COMPANY_ID;
		}
	...
	public function setLoginId($v)
	{
		...
		if ($this->login_id !== $v) {
			$this->login_id = $v;
			$this->modifiedColumns[] = CompanyLoginPeer::LOGIN_ID;
		}
	...
	public function setRoleId($v)
	{
		...
		if ($this->role_id !== $v) {
			$this->role_id = $v;
			$this->modifiedColumns[] = CompanyLoginPeer::ROLE_ID;
		}
	...
	public function setCreatedAt($v)
	{
		...
		if ( $this->created_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = CompanyLoginPeer::CREATED_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 5; // 5 = CompanyLoginPeer::NUM_COLUMNS - CompanyLoginPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CompanyLogin object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CompanyLoginPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCompanyLogin:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CompanyLoginPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCompanyLogin:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCompanyLogin:save:pre') as $callable)
    {
    ...
    if ($this->isNew() && !$this->isColumnModified(CompanyLoginPeer::CREATED_AT))
    {
      $this->setCreatedAt(time());
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCompanyLogin:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CompanyLoginPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CompanyLoginPeer::doInsert($this, $con);
					...
					$affectedRows += CompanyLoginPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CompanyLoginPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CompanyLoginPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CompanyLoginPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyLoginPeer::ID)) $criteria->add(CompanyLoginPeer::ID, $this->id);
		if ($this->isColumnModified(CompanyLoginPeer::COMPANY_ID)) $criteria->add(CompanyLoginPeer::COMPANY_ID, $this->company_id);
		if ($this->isColumnModified(CompanyLoginPeer::LOGIN_ID)) $criteria->add(CompanyLoginPeer::LOGIN_ID, $this->login_id);
		if ($this->isColumnModified(CompanyLoginPeer::ROLE_ID)) $criteria->add(CompanyLoginPeer::ROLE_ID, $this->role_id);
		if ($this->isColumnModified(CompanyLoginPeer::CREATED_AT)) $criteria->add(CompanyLoginPeer::CREATED_AT, $this->created_at);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CompanyLoginPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CompanyLogin (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CompanyLogin Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CompanyLoginPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CompanyLoginPeer();
		}
		return self::$peer;
	}
	...
	public function getCompany(PropelPDO $con = null)
	{
		if ($this->aCompany === null && ($this->company_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCompany->addCompanyLogins($this);
			 */
		}
	...
	public function getLogin(PropelPDO $con = null)
	{
		if ($this->aLogin === null && ($this->login_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aLogin->addCompanyLogins($this);
			 */
		}
		return $this->aLogin;
	}
	...
	public function getRole(PropelPDO $con = null)
	{
		if ($this->aRole === null && ($this->role_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aRole->addCompanyLogins($this);
			 */
		}
		return $this->aRole;
	}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCompanyLogin:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCompanyLogin::%s', $method));
    }
