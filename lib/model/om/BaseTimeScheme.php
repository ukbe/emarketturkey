...
/**
 * Base class that represents a row from the 'EMT_TIME_SCHEME' table.
 *
 * 
 *
 ...
 */
abstract class BaseTimeScheme extends BaseObject  implements Persistent {


  const PEER = 'TimeSchemePeer';
	...
	/**
	 * The value for the repeat_type_id field.
	 * Note: this column has a database default value of: 1
	 * @var        int
	 */
	protected $repeat_type_id;
	...
	/**
	 * Initializes internal state of BaseTimeScheme object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [repeat_type_id] column value.
	 * 
	 * @return     int
	 */
	public function getRepeatTypeId()
	{
	 ...
	 * @return     TimeScheme The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TimeSchemePeer::ID;
		}
	...
	public function setStartDate($v)
	{
		...
		if ( $this->start_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TimeSchemePeer::START_DATE;
			}
	...
	public function setEndDate($v)
	{
		...
		if ( $this->end_date !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = TimeSchemePeer::END_DATE;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [repeat_type_id] column.
	 * 
	 * @param      int $v new value
	 * @return     TimeScheme The current object (for fluent API support)
	 */
	public function setRepeatTypeId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->repeat_type_id !== $v || $v === 1) {
			$this->repeat_type_id = $v;
			$this->modifiedColumns[] = TimeSchemePeer::REPEAT_TYPE_ID;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(TimeSchemePeer::REPEAT_TYPE_ID))) {
				return false;
			}

			if ($this->repeat_type_id !== 1) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->repeat_type_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = TimeSchemePeer::NUM_COLUMNS - TimeSchemePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating TimeScheme object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TimeSchemePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseTimeScheme:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			TimeSchemePeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseTimeScheme:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseTimeScheme:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseTimeScheme:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			TimeSchemePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TimeSchemePeer::doInsert($this, $con);
					...
					$affectedRows += TimeSchemePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TimeSchemePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TimeSchemePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TimeSchemePeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getStartDate(),
			$keys[2] => $this->getEndDate(),
			$keys[3] => $this->getRepeatTypeId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setRepeatTypeId($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TimeSchemePeer::ID)) $criteria->add(TimeSchemePeer::ID, $this->id);
		if ($this->isColumnModified(TimeSchemePeer::START_DATE)) $criteria->add(TimeSchemePeer::START_DATE, $this->start_date);
		if ($this->isColumnModified(TimeSchemePeer::END_DATE)) $criteria->add(TimeSchemePeer::END_DATE, $this->end_date);
		if ($this->isColumnModified(TimeSchemePeer::REPEAT_TYPE_ID)) $criteria->add(TimeSchemePeer::REPEAT_TYPE_ID, $this->repeat_type_id);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TimeSchemePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TimeScheme (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRepeatTypeId($this->repeat_type_id);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TimeScheme Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TimeSchemePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TimeSchemePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this TimeScheme has previously been saved, it will retrieve
	 * related Events from storage. If this TimeScheme is new, it will return
		...
		if ($this->collEvents === null) {
			if ($this->isNew()) {
			   $this->collEvents = array();
				...
				$criteria->add(EventPeer::TIME_SCHEME_ID, $this->id);
	 ...
	 * Otherwise if this TimeScheme is new, it will return
	 * an empty collection; or if this TimeScheme has previously
	 * been saved, it will retrieve related Events from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TimeScheme.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseTimeScheme:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseTimeScheme::%s', $method));
    }
