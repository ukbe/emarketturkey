...
/**
 * Base class that represents a row from the 'EMT_PRODUCT_I18N' table.
 *
 * 
 *
...
abstract class BaseProductI18n extends BaseObject  implements Persistent {
  ...
  const PEER = 'ProductI18nPeer';
	...
	/**
	 * Get the [packaging] column value.
	 * 
	 * @return     string
	 */
	...
	public function setIntroduction($v)
	{
		...
		if ($this->introduction !== $v) {
			$this->introduction = $v;
			$this->modifiedColumns[] = ProductI18nPeer::INTRODUCTION;
		}
	...
	/**
	 * Set the value of [packaging] column.
	 * 
	 * @param      string $v new value
	 * @return     ProductI18n The current object (for fluent API support)
	 */
	public function setPackaging($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}
		...
		if ($this->packaging !== $v) {
			$this->packaging = $v;
			$this->modifiedColumns[] = ProductI18nPeer::PACKAGING;
		}
	...
	public function setHtmlContent($v)
	{
		...
		if ($this->html_content !== $v) {
			$this->html_content = $v;
			$this->modifiedColumns[] = ProductI18nPeer::HTML_CONTENT;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->packaging = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->html_content = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->resetModified();
			...
			return $startcol + 6; // 6 = ProductI18nPeer::NUM_COLUMNS - ProductI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setPackaging($arr[$keys[4]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductI18nPeer::INTRODUCTION)) $criteria->add(ProductI18nPeer::INTRODUCTION, $this->introduction);
		if ($this->isColumnModified(ProductI18nPeer::PACKAGING)) $criteria->add(ProductI18nPeer::PACKAGING, $this->packaging);
		if ($this->isColumnModified(ProductI18nPeer::HTML_CONTENT)) $criteria->add(ProductI18nPeer::HTML_CONTENT, $this->html_content);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setPackaging($this->packaging);

		$copyObj->setHtmlContent($this->html_content);
