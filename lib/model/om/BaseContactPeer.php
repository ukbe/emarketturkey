...
/**
 * Base static class for performing query and update operations on the 'EMT_CONTACT' table.
 *
 * 
 *
...
abstract class BaseContactPeer {
	...
	const ID = 'EMT_CONTACT.ID';

	/** the column name for the EMAIL field */
	const EMAIL = 'EMT_CONTACT.EMAIL';

	/** the column name for the GTALK field */
	const GTALK = 'EMT_CONTACT.GTALK';

	/** the column name for the MSN field */
	const MSN = 'EMT_CONTACT.MSN';

	/** the column name for the YAHOO field */
	const YAHOO = 'EMT_CONTACT.YAHOO';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'EMT_CONTACT.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'EMT_CONTACT.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Email', 'Gtalk', 'Msn', 'Yahoo', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'email', 'gtalk', 'msn', 'yahoo', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::EMAIL, self::GTALK, self::MSN, self::YAHOO, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'EMAIL', 'GTALK', 'MSN', 'YAHOO', 'CREATED_AT', 'UPDATED_AT', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Email' => 1, 'Gtalk' => 2, 'Msn' => 3, 'Yahoo' => 4, 'CreatedAt' => 5, 'UpdatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'email' => 1, 'gtalk' => 2, 'msn' => 3, 'yahoo' => 4, 'createdAt' => 5, 'updatedAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::EMAIL => 1, self::GTALK => 2, self::MSN => 3, self::YAHOO => 4, self::CREATED_AT => 5, self::UPDATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'EMAIL' => 1, 'GTALK' => 2, 'MSN' => 3, 'YAHOO' => 4, 'CREATED_AT' => 5, 'UPDATED_AT' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ContactPeer::GTALK);

		$criteria->addSelectColumn(ContactPeer::MSN);

		$criteria->addSelectColumn(ContactPeer::YAHOO);
    ...
    foreach (sfMixer::getCallables('BaseContactPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseContactPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseContactPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_CONTACT table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in ContactAddressPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			...
			// invalidate objects in CompanyProfilePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c = new Criteria(ContactPhonePeer::DATABASE_NAME);
			
			$c->add(ContactPhonePeer::CONTACT_ID, $obj->getId());
			$affectedRows += ContactPhonePeer::doDelete($c, $con);

			// delete related ContactAddress objects
			$c = new Criteria(ContactAddressPeer::DATABASE_NAME);
			
			$c->add(ContactAddressPeer::CONTACT_ID, $obj->getId());
			$affectedRows += ContactAddressPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$selectCriteria->add(UserProfilePeer::CONTACT_ID, $obj->getId());
			$updateValues->add(UserProfilePeer::CONTACT_ID, null);

					BasePeer::doUpdate($selectCriteria, $updateValues, $con); // use BasePeer because generated Peer doUpdate() methods only update using pkey

			// set fkey col in related CompanyProfile rows to NULL
			$selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContactPeer::DATABASE_NAME);
			$selectCriteria->add(CompanyProfilePeer::CONTACT_ID, $obj->getId());
			$updateValues->add(CompanyProfilePeer::CONTACT_ID, null);
			...
			$selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContactPeer::DATABASE_NAME);
			$selectCriteria->add(ResumePeer::CONTACT_ID, $obj->getId());
			$updateValues->add(ResumePeer::CONTACT_ID, null);
			...
			$selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContactPeer::DATABASE_NAME);
			$selectCriteria->add(ResumeReferencePeer::USER_CONTACT_ID, $obj->getId());
			$updateValues->add(ResumeReferencePeer::USER_CONTACT_ID, null);
			...
			$selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContactPeer::DATABASE_NAME);
			$selectCriteria->add(GroupPeer::CONTACT_ID, $obj->getId());
			$updateValues->add(GroupPeer::CONTACT_ID, null);
			...
			$selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
			$updateValues = new Criteria(ContactPeer::DATABASE_NAME);
			$selectCriteria->add(PlacePeer::CONTACT_ID, $obj->getId());
			$updateValues->add(PlacePeer::CONTACT_ID, null);
...
//
// NOTE: This static code cannot call methods on the ContactPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ContactPeer class:
//
// Propel::getDatabaseMap(ContactPeer::DATABASE_NAME)->addTableBuilder(ContactPeer::TABLE_NAME, ContactPeer::getMapBuilder());
//
