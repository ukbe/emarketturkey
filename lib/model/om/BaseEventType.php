...
/**
 * Base class that represents a row from the 'EMT_EVENT_TYPE' table.
 *
 * 
 *
...
abstract class BaseEventType extends BaseObject  implements Persistent {
  ...
  const PEER = 'EventTypePeer';
	...
	/**
	 * The value for the type_class field.
	 * @var        int
	 */
	protected $type_class;

	/**
	 * @var        array EventTypeI18n[] Collection to store aggregation of EventTypeI18n objects.
	 */
	protected $collEventTypeI18ns;

	/**
	 * @var        Criteria The criteria used to select the current contents of collEventTypeI18ns.
	 */
	private $lastEventTypeI18nCriteria = null;
  ...
  protected $culture;
	...
	/**
	 * Get the [type_class] column value.
	 * 
	 * @return     int
	 */
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v || $v === 1) {
			$this->active = $v;
			$this->modifiedColumns[] = EventTypePeer::ACTIVE;
		}
	...
	/**
	 * Set the value of [type_class] column.
	 * 
	 * @param      int $v new value
	 * @return     EventType The current object (for fluent API support)
	 */
	public function setTypeClass($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->type_class !== $v) {
			$this->type_class = $v;
			$this->modifiedColumns[] = EventTypePeer::TYPE_CLASS;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(EventTypePeer::ACTIVE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->type_class = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->resetModified();
			...
			return $startcol + 3; // 3 = EventTypePeer::NUM_COLUMNS - EventTypePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->collEventTypeI18ns = null;
			$this->lastEventTypeI18nCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collEventTypeI18ns !== null) {
				foreach ($this->collEventTypeI18ns as $referrerFK) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setTypeClass($arr[$keys[2]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(EventTypePeer::ACTIVE)) $criteria->add(EventTypePeer::ACTIVE, $this->active);
		if ($this->isColumnModified(EventTypePeer::TYPE_CLASS)) $criteria->add(EventTypePeer::TYPE_CLASS, $this->type_class);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTypeClass($this->type_class);
		...
		if ($deepCopy) {
			...
			foreach ($this->getEventTypeI18ns() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addEventTypeI18n($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collEventTypeI18ns collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 * @return     void
	 * @see        addEventTypeI18ns()
	 */
	public function clearEventTypeI18ns()
	{
		$this->collEventTypeI18ns = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collEventTypeI18ns collection (array).
	 *
	 * By default this just sets the collEventTypeI18ns collection to an empty array (like clearcollEventTypeI18ns());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initEventTypeI18ns()
	{
		$this->collEventTypeI18ns = array();
	}

	/**
	 * Gets an array of EventTypeI18n objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this EventType has previously been saved, it will retrieve
	 * related EventTypeI18ns from storage. If this EventType is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array EventTypeI18n[]
	 * @throws     PropelException
	 */
	public function getEventTypeI18ns($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EventTypePeer::DATABASE_NAME);
		}
		...
		if ($this->collEventTypeI18ns === null) {
			if ($this->isNew()) {
			   $this->collEventTypeI18ns = array();
				...
				$criteria->add(EventTypeI18nPeer::ID, $this->id);

				EventTypeI18nPeer::addSelectColumns($criteria);
				$this->collEventTypeI18ns = EventTypeI18nPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				EventTypeI18nPeer::addSelectColumns($criteria);
				if (!isset($this->lastEventTypeI18nCriteria) || !$this->lastEventTypeI18nCriteria->equals($criteria)) {
					$this->collEventTypeI18ns = EventTypeI18nPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastEventTypeI18nCriteria = $criteria;
		return $this->collEventTypeI18ns;
	}

	/**
	 * Returns the number of related EventTypeI18n objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related EventTypeI18n objects.
	 * @throws     PropelException
	 */
	public function countEventTypeI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(EventTypePeer::DATABASE_NAME);
		} else {
		...
		if ($this->collEventTypeI18ns === null) {
			if ($this->isNew()) {
				...
				$count = EventTypeI18nPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastEventTypeI18nCriteria) || !$this->lastEventTypeI18nCriteria->equals($criteria)) {
					...
					$count = count($this->collEventTypeI18ns);
				}
			} else {
				$count = count($this->collEventTypeI18ns);
			}
	...
	/**
	 * Method called to associate a EventTypeI18n object to this object
	 * through the EventTypeI18n foreign key attribute.
	 *
	 * @param      EventTypeI18n $l EventTypeI18n
	 * @return     void
	 * @throws     PropelException
	 */
	public function addEventTypeI18n(EventTypeI18n $l)
	{
		if ($this->collEventTypeI18ns === null) {
			$this->initEventTypeI18ns();
		}
		if (!in_array($l, $this->collEventTypeI18ns, true)) { // only add it if the **same** object is not already associated
			array_push($this->collEventTypeI18ns, $l);
			$l->setEventType($this);
		}
	}
		...
		if ($this->collEvents === null) {
			if ($this->isNew()) {
			   $this->collEvents = array();
				...
				$criteria->add(EventPeer::TYPE_ID, $this->id);
	...
	{
		if ($deep) {
			if ($this->collEventTypeI18ns) {
				foreach ((array) $this->collEventTypeI18ns as $o) {
  ...
  {
    return $this->getCurrentEventTypeI18n($culture)->getName();
  }

  public function setName($value, $culture = null)
  {
    $this->getCurrentEventTypeI18n($culture)->setName($value);
  }

  protected $current_i18n = array();

  public function getCurrentEventTypeI18n($culture = null)
  {
    if (is_null($culture))
    {
    ...
    {
      $obj = EventTypeI18nPeer::retrieveByPK($this->getId(), $culture);
      if ($obj)
      {
        $this->setEventTypeI18nForCulture($obj, $culture);
      }
      else
      {
        $this->setEventTypeI18nForCulture(new EventTypeI18n(), $culture);
  ...
  public function setEventTypeI18nForCulture($object, $culture)
  {
    $this->current_i18n[$culture] = $object;
    $this->addEventTypeI18n($object);
  }
