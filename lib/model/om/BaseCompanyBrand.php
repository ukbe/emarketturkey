...
/**
 * Base class that represents a row from the 'EMT_COMPANY_BRAND' table.
 *
 * 
 *
 ...
 */
abstract class BaseCompanyBrand extends BaseObject  implements Persistent {


  const PEER = 'CompanyBrandPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        CompanyBrandPeer
	 */
	...
	/**
	 * The value for the target_markets field.
	 * @var        string
	 */
	protected $target_markets;
	...
	/**
	 * Initializes internal state of BaseCompanyBrand object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [target_markets] column value.
	 * 
	 * @return     string
	 */
	public function getTargetMarkets()
	{
		return $this->target_markets;
	}
	 ...
	 * @return     CompanyBrand The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = CompanyBrandPeer::ID;
		}
	...
	public function setCompanyId($v)
	{
		...
		if ($this->company_id !== $v) {
			$this->company_id = $v;
			$this->modifiedColumns[] = CompanyBrandPeer::COMPANY_ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CompanyBrandPeer::NAME;
		}
	...
	/**
	 * Set the value of [target_markets] column.
	 * 
	 * @param      string $v new value
	 * @return     CompanyBrand The current object (for fluent API support)
	 */
	public function setTargetMarkets($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->target_markets !== $v) {
			$this->target_markets = $v;
			$this->modifiedColumns[] = CompanyBrandPeer::TARGET_MARKETS;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->target_markets = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->resetModified();
			...
			return $startcol + 4; // 4 = CompanyBrandPeer::NUM_COLUMNS - CompanyBrandPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating CompanyBrand object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = CompanyBrandPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseCompanyBrand:delete:pre') as $callable)
    {
      ...
      if ($ret)
      {
		...
		try {
			CompanyBrandPeer::doDelete($this, $con);
    ...
    foreach (sfMixer::getCallables('BaseCompanyBrand:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseCompanyBrand:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseCompanyBrand:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			CompanyBrandPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = CompanyBrandPeer::doInsert($this, $con);
					...
					$affectedRows += CompanyBrandPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = CompanyBrandPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = CompanyBrandPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = CompanyBrandPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getCompanyId(),
			$keys[2] => $this->getName(),
			$keys[3] => $this->getTargetMarkets(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setTargetMarkets($arr[$keys[3]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CompanyBrandPeer::ID)) $criteria->add(CompanyBrandPeer::ID, $this->id);
		if ($this->isColumnModified(CompanyBrandPeer::COMPANY_ID)) $criteria->add(CompanyBrandPeer::COMPANY_ID, $this->company_id);
		if ($this->isColumnModified(CompanyBrandPeer::NAME)) $criteria->add(CompanyBrandPeer::NAME, $this->name);
		if ($this->isColumnModified(CompanyBrandPeer::TARGET_MARKETS)) $criteria->add(CompanyBrandPeer::TARGET_MARKETS, $this->target_markets);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(CompanyBrandPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of CompanyBrand (or compatible) type.
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setTargetMarkets($this->target_markets);
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     CompanyBrand Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     CompanyBrandPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new CompanyBrandPeer();
		}
		return self::$peer;
	}
	...
	public function getCompany(PropelPDO $con = null)
	{
		if ($this->aCompany === null && ($this->company_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aCompany->addCompanyBrands($this);
			 */
		}
	 ...
	 * Otherwise if this CompanyBrand has previously been saved, it will retrieve
	 * related Products from storage. If this CompanyBrand is new, it will return
		...
		if ($this->collProducts === null) {
			if ($this->isNew()) {
			   $this->collProducts = array();
				...
				$criteria->add(ProductPeer::BRAND_ID, $this->id);
	 ...
	 * Otherwise if this CompanyBrand is new, it will return
	 * an empty collection; or if this CompanyBrand has previously
	 * been saved, it will retrieve related Products from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in CompanyBrand.
	 */
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseCompanyBrand:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseCompanyBrand::%s', $method));
    }
