...
/**
 * Base class that represents a row from the 'EMT_PRODUCT_GROUP_I18N' table.
 *
 * 
 *
  ...
  const PEER = 'ProductGroupI18nPeer';
	...
	public function setStrippedName($v)
	{
		...
		if ($this->stripped_name !== $v) {
			...
			$this->modifiedColumns[] = ProductGroupI18nPeer::STRIPPED_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ProductGroupI18nPeer::NUM_COLUMNS - ProductGroupI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ProductGroupI18nPeer::STRIPPED_NAME)) $criteria->add(ProductGroupI18nPeer::STRIPPED_NAME, $this->stripped_name);
