...
/**
 * Base static class for performing query and update operations on the 'EMT_PAYMENT_TYPE' table.
 *
 * 
 *
...
abstract class BasePaymentTypePeer {
	...
	const TABLE_NAME = 'EMT_PAYMENT_TYPE';
	...
	const ID = 'EMT_PAYMENT_TYPE.ID';

	/** the column name for the ACTIVE field */
	const ACTIVE = 'EMT_PAYMENT_TYPE.ACTIVE';
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    foreach (sfMixer::getCallables('BasePaymentTypePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BasePaymentTypePeer', $c, $con);
    }
    ...
    $startcol = (PaymentTypePeer::NUM_COLUMNS - PaymentTypePeer::NUM_LAZY_LOAD_COLUMNS);

    PaymentTypeI18nPeer::addSelectColumns($c);

    $c->addJoin(PaymentTypePeer::ID, PaymentTypeI18nPeer::ID);
    $c->add(PaymentTypeI18nPeer::CULTURE, $culture);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_PAYMENT_TYPE table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += PaymentTypePeer::doOnDeleteCascade(new Criteria(PaymentTypePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in PaymentTypeI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c = new Criteria(PaymentTypeI18nPeer::DATABASE_NAME);
