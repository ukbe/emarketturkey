...
/**
 * Base class that represents a row from the 'EMT_PURCHASE' table.
 *
 * 
 *
...
abstract class BasePurchase extends BaseObject  implements Persistent {
  ...
  const PEER = 'PurchasePeer';
	...
	/**
	 * The value for the buyer_type_id field.
	 * @var        int
	 */
	protected $buyer_type_id;
	...
	/**
	 * Get the [buyer_type_id] column value.
	 * 
	 * @return     int
	 */
	...
	public function setGuid($v)
	{
		...
		if ($this->guid !== $v || $v === 'sys_guid()') {
			$this->guid = $v;
			$this->modifiedColumns[] = PurchasePeer::GUID;
		}
	...
	public function setBuyerId($v)
	{
		...
		if ($this->buyer_id !== $v) {
			$this->buyer_id = $v;
			$this->modifiedColumns[] = PurchasePeer::BUYER_ID;
		}
	...
	/**
	 * Set the value of [buyer_type_id] column.
	 * 
	 * @param      int $v new value
	 * @return     Purchase The current object (for fluent API support)
	 */
	public function setBuyerTypeId($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->buyer_type_id !== $v) {
			$this->buyer_type_id = $v;
			$this->modifiedColumns[] = PurchasePeer::BUYER_TYPE_ID;
		}
	...
	public function setActive($v)
	{
		...
		if ($this->active !== $v || $v === false) {
			$this->active = $v;
			$this->modifiedColumns[] = PurchasePeer::ACTIVE;
		}
	...
	public function setSubTotal($v)
	{
		...
		if ($this->sub_total !== $v) {
			$this->sub_total = $v;
			$this->modifiedColumns[] = PurchasePeer::SUB_TOTAL;
		}
	...
	public function setStatus($v)
	{
		...
		if ($this->status !== $v || $v === 0) {
			$this->status = $v;
			$this->modifiedColumns[] = PurchasePeer::STATUS;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(PurchasePeer::GUID,PurchasePeer::ACTIVE,PurchasePeer::STATUS))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->buyer_type_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			$this->active = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->sub_total = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
			...
			return $startcol + 9; // 9 = PurchasePeer::NUM_COLUMNS - PurchasePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aPrivacyNodeType !== null && $this->buyer_type_id !== $this->aPrivacyNodeType->getId()) {
			$this->aPrivacyNodeType = null;
		}
	} // ensureConsistency
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setBuyerTypeId($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PurchasePeer::GUID)) $criteria->add(PurchasePeer::GUID, $this->guid);
		if ($this->isColumnModified(PurchasePeer::BUYER_ID)) $criteria->add(PurchasePeer::BUYER_ID, $this->buyer_id);
		if ($this->isColumnModified(PurchasePeer::BUYER_TYPE_ID)) $criteria->add(PurchasePeer::BUYER_TYPE_ID, $this->buyer_type_id);
		if ($this->isColumnModified(PurchasePeer::ACTIVE)) $criteria->add(PurchasePeer::ACTIVE, $this->active);
		if ($this->isColumnModified(PurchasePeer::SUB_TOTAL)) $criteria->add(PurchasePeer::SUB_TOTAL, $this->sub_total);
		if ($this->isColumnModified(PurchasePeer::STATUS)) $criteria->add(PurchasePeer::STATUS, $this->status);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setBuyerTypeId($this->buyer_type_id);
	...
	{
		if ($v === null) {
			$this->setBuyerTypeId(NULL);
		} else {
			$this->setBuyerTypeId($v->getId());
		}
	...
	{
		if ($this->aPrivacyNodeType === null && ($this->buyer_type_id !== null)) {
			$c = new Criteria(PrivacyNodeTypePeer::DATABASE_NAME);
			$c->add(PrivacyNodeTypePeer::ID, $this->buyer_type_id);
			...
			/* The following can be used additionally to
			   ...
			   $this->aPrivacyNodeType->addPurchases($this);
			 */
		}
	 ...
	 * Otherwise if this Purchase has previously been saved, it will retrieve
	 * related PurchaseItems from storage. If this Purchase is new, it will return
		...
		if ($this->collPurchaseItems === null) {
			if ($this->isNew()) {
			   $this->collPurchaseItems = array();
				...
				$criteria->add(PurchaseItemPeer::PURCHASE_ID, $this->id);
	 ...
	 */
	public function getPurchaseItemsJoinMarketingPackage($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PurchasePeer::DATABASE_NAME);
		}
		...
		if ($this->collPurchaseItems === null) {
			if ($this->isNew()) {
				...
				$this->collPurchaseItems = PurchaseItemPeer::doSelectJoinMarketingPackage($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Purchase has previously been saved, it will retrieve
	 * related Payments from storage. If this Purchase is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collPayments === null) {
			if ($this->isNew()) {
			   $this->collPayments = array();
				...
				$criteria->add(PaymentPeer::PURCHASE_ID, $this->id);
