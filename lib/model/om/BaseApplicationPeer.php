...
/**
 * Base static class for performing query and update operations on the 'EMT_APPLICATION' table.
 *
 * 
 *
...
abstract class BaseApplicationPeer {
	...
	const TABLE_NAME = 'EMT_APPLICATION';
	...
	const ID = 'EMT_APPLICATION.ID';

	/** the column name for the APP_CODE field */
	const APP_CODE = 'EMT_APPLICATION.APP_CODE';

	/** the column name for the CREATED_AT field */
	const CREATED_AT = 'EMT_APPLICATION.CREATED_AT';

	/** the column name for the UPDATED_AT field */
	const UPDATED_AT = 'EMT_APPLICATION.UPDATED_AT';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'AppCode', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'appCode', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::APP_CODE, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'APP_CODE', 'CREATED_AT', 'UPDATED_AT', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'AppCode' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'appCode' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::APP_CODE => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'APP_CODE' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ApplicationPeer::APP_CODE);
  ...
  /**
   * Selects a collection of Application objects pre-filled with their i18n objects.
   *
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_APPLICATION table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += ApplicationPeer::doOnDeleteCascade(new Criteria(ApplicationPeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in ApplicationI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			...
			// invalidate objects in MarketingPackagePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ApplicationI18n objects
			$c = new Criteria(ApplicationI18nPeer::DATABASE_NAME);
			
			$c->add(ApplicationI18nPeer::ID, $obj->getId());
			$affectedRows += ApplicationI18nPeer::doDelete($c, $con);

			// delete related Service objects
			$c = new Criteria(ServicePeer::DATABASE_NAME);
			
			$c->add(ServicePeer::APPLICATION_ID, $obj->getId());
			$affectedRows += ServicePeer::doDelete($c, $con);

			// delete related MarketingPackage objects
			$c = new Criteria(MarketingPackagePeer::DATABASE_NAME);
			
			$c->add(MarketingPackagePeer::APPLICATION_ID, $obj->getId());
			$affectedRows += MarketingPackagePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
