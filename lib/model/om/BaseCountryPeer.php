...
/**
 * Base static class for performing query and update operations on the 'EMT_COUNTRY' table.
 *
 * 
 *
...
abstract class BaseCountryPeer {
	...
	const ID = 'EMT_COUNTRY.ID';

	/** the column name for the ISO field */
	const ISO = 'EMT_COUNTRY.ISO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Iso', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'iso', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ISO, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'ISO', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Iso' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'iso' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ISO => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'ISO' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
  ...
  /**
   * Selects a collection of Country objects pre-filled with their i18n objects.
   *
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_COUNTRY table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in CountryI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related CountryI18n objects
			$c = new Criteria(CountryI18nPeer::DATABASE_NAME);
			
			$c->add(CountryI18nPeer::ID, $obj->getId());
			$affectedRows += CountryI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
