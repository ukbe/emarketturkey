...
/**
 * Base static class for performing query and update operations on the 'EMT_COUNTRY_I18N' table.
 *
 * 
 *
...
abstract class BaseCountryI18nPeer {
	...
	const TABLE_NAME = 'EMT_COUNTRY_I18N';
	...
	const ID = 'EMT_COUNTRY_I18N.ID';

	/** the column name for the CULTURE field */
	const CULTURE = 'EMT_COUNTRY_I18N.CULTURE';

	/** the column name for the NAME field */
	const NAME = 'EMT_COUNTRY_I18N.NAME';

	/** the column name for the STRIPPED_NAME field */
	const STRIPPED_NAME = 'EMT_COUNTRY_I18N.STRIPPED_NAME';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new CountryI18nMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CountryI18nPeer::NAME);

		$criteria->addSelectColumn(CountryI18nPeer::STRIPPED_NAME);
    ...
    foreach (sfMixer::getCallables('BaseCountryI18nPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseCountryI18nPeer', $c, $con);
		...
		$c->addJoin(array(CountryI18nPeer::ID,), array(CountryPeer::ID,), $join_behavior);
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_COUNTRY_I18N table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof CountryI18n) {
...
//
// NOTE: This static code cannot call methods on the CountryI18nPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the CountryI18nPeer class:
//
// Propel::getDatabaseMap(CountryI18nPeer::DATABASE_NAME)->addTableBuilder(CountryI18nPeer::TABLE_NAME, CountryI18nPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseCountryI18nPeer::DATABASE_NAME)->addTableBuilder(BaseCountryI18nPeer::TABLE_NAME, BaseCountryI18nPeer::getMapBuilder());
