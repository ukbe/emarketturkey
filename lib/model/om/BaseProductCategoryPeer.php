...
/**
 * Base static class for performing query and update operations on the 'EMT_PRODUCT_CATEGORY' table.
 *
 * 
 *
...
abstract class BaseProductCategoryPeer {
	...
	const TABLE_NAME = 'EMT_PRODUCT_CATEGORY';
	...
	const ID = 'EMT_PRODUCT_CATEGORY.ID';

	/** the column name for the PARENT_ID field */
	const PARENT_ID = 'EMT_PRODUCT_CATEGORY.PARENT_ID';
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ProductCategoryMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseProductCategoryPeer', $criteria, $con);
    }
  ...
  /**
   * Selects a collection of ProductCategory objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    foreach (sfMixer::getCallables('BaseProductCategoryPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseProductCategoryPeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	/**
	 * Method to DELETE all rows from the EMT_PRODUCT_CATEGORY table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += ProductCategoryPeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in ProductCategoryI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
			ProductCategoryI18nPeer::clearInstancePool();

			// invalidate objects in ProductAttrDefPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ProductCategoryI18n objects
			$c = new Criteria(ProductCategoryI18nPeer::DATABASE_NAME);
			
			$c->add(ProductCategoryI18nPeer::ID, $obj->getId());
			$affectedRows += ProductCategoryI18nPeer::doDelete($c, $con);

			// delete related ProductAttrDef objects
			$c = new Criteria(ProductAttrDefPeer::DATABASE_NAME);
			
			$c->add(ProductAttrDefPeer::CATEGORY_ID, $obj->getId());
			$affectedRows += ProductAttrDefPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
//
// NOTE: This static code cannot call methods on the ProductCategoryPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the ProductCategoryPeer class:
//
// Propel::getDatabaseMap(ProductCategoryPeer::DATABASE_NAME)->addTableBuilder(ProductCategoryPeer::TABLE_NAME, ProductCategoryPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseProductCategoryPeer::DATABASE_NAME)->addTableBuilder(BaseProductCategoryPeer::TABLE_NAME, BaseProductCategoryPeer::getMapBuilder());
