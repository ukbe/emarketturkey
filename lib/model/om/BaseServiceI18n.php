...
/**
 * Base class that represents a row from the 'EMT_SERVICE_I18N' table.
 *
 * 
 *
...
abstract class BaseServiceI18n extends BaseObject  implements Persistent {
  ...
  const PEER = 'ServiceI18nPeer';
	...
	/**
	 * Initializes internal state of BaseServiceI18n object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ServiceI18n The current object (for fluent API support)
	 */
	...
	public function setIntroduction($v)
	{
		...
		if ($this->introduction !== $v) {
			$this->introduction = $v;
			$this->modifiedColumns[] = ServiceI18nPeer::INTRODUCTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = ServiceI18nPeer::NUM_COLUMNS - ServiceI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aService !== null && $this->id !== $this->aService->getId()) {
			$this->aService = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ServiceI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseServiceI18n:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			ServiceI18nPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ServiceI18nPeer::INTRODUCTION)) $criteria->add(ServiceI18nPeer::INTRODUCTION, $this->introduction);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ServiceI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ServiceI18n Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getService(PropelPDO $con = null)
	{
		if ($this->aService === null && ($this->id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aService->addServiceI18ns($this);
			 */
		}
