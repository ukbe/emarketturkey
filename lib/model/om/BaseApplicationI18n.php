...
/**
 * Base class that represents a row from the 'EMT_APPLICATION_I18N' table.
 *
 * 
 *
...
abstract class BaseApplicationI18n extends BaseObject  implements Persistent {
  ...
  const PEER = 'ApplicationI18nPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        ApplicationI18nPeer
	 */
	...
	/**
	 * Initializes internal state of BaseApplicationI18n object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     ApplicationI18n The current object (for fluent API support)
	 */
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = ApplicationI18nPeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ApplicationI18nPeer::NUM_COLUMNS - ApplicationI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aApplication !== null && $this->id !== $this->aApplication->getId()) {
			$this->aApplication = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = ApplicationI18nPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BaseApplicationI18n:delete:pre') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseApplicationI18n:delete:post') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseApplicationI18n:save:pre') as $callable)
    {
      ...
      if (is_int($affectedRows))
      {
		...
		try {
			...
			$con->commit();
    foreach (sfMixer::getCallables('BaseApplicationI18n:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
    }

			ApplicationI18nPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ApplicationI18nPeer::NAME)) $criteria->add(ApplicationI18nPeer::NAME, $this->name);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of ApplicationI18n (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     ApplicationI18n Clone of current object.
	 * @throws     PropelException
	 */
	...
	public function getApplication(PropelPDO $con = null)
	{
		if ($this->aApplication === null && ($this->id !== null)) {
			...
			$c->add(ApplicationPeer::ID, $this->id);
			...
			/* The following can be used additionally to
			   ...
			   $this->aApplication->addApplicationI18ns($this);
			 */
		}
  ...
  {
    if (!$callable = sfMixer::getCallable('BaseApplicationI18n:'.$method))
    {
      throw new sfException(sprintf('Call to undefined method BaseApplicationI18n::%s', $method));
    }
