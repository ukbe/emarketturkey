...
/**
 * Base class that represents a row from the 'EMT_COUNTRY_I18N' table.
 *
 * 
 *
...
abstract class BaseCountryI18n extends BaseObject  implements Persistent {
  ...
  const PEER = 'CountryI18nPeer';
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v) {
			$this->name = $v;
			$this->modifiedColumns[] = CountryI18nPeer::NAME;
		}
	...
	public function setStrippedName($v)
	{
		...
		if ($this->stripped_name !== $v) {
			...
			$this->modifiedColumns[] = CountryI18nPeer::STRIPPED_NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = CountryI18nPeer::NUM_COLUMNS - CountryI18nPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(CountryI18nPeer::NAME)) $criteria->add(CountryI18nPeer::NAME, $this->name);
		if ($this->isColumnModified(CountryI18nPeer::STRIPPED_NAME)) $criteria->add(CountryI18nPeer::STRIPPED_NAME, $this->stripped_name);
