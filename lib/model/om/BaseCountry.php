...
/**
 * Base class that represents a row from the 'EMT_COUNTRY' table.
 *
 * 
 *
...
abstract class BaseCountry extends BaseObject  implements Persistent {
	...
	public function countCountryI18ns(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collCountryI18ns === null) {
			if ($this->isNew()) {
				...
				$count = CountryI18nPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
  ...
  {
    return $this->getCurrentCountryI18n($culture)->getName();
  }

  public function setName($value, $culture = null)
  {
    $this->getCurrentCountryI18n($culture)->setName($value);
  }

  public function getStrippedName($culture = null)
  {
    return $this->getCurrentCountryI18n($culture)->getStrippedName();
  }

  public function setStrippedName($value, $culture = null)
  {
    $this->getCurrentCountryI18n($culture)->setStrippedName($value);
  }
