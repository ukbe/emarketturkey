...
/**
 * Base static class for performing query and update operations on the 'EMT_EVENT_TYPE' table.
 *
 * 
 *
...
abstract class BaseEventTypePeer {
	...
	const TABLE_NAME = 'EMT_EVENT_TYPE';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.EventType';
	...
	const ID = 'EMT_EVENT_TYPE.ID';

	/** the column name for the ACTIVE field */
	const ACTIVE = 'EMT_EVENT_TYPE.ACTIVE';

	/** the column name for the TYPE_CLASS field */
	const TYPE_CLASS = 'EMT_EVENT_TYPE.TYPE_CLASS';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Active', 'TypeClass', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'active', 'typeClass', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::ACTIVE, self::TYPE_CLASS, ),
		BasePeer::TYPE_FIELDNAME => array ('ID', 'ACTIVE', 'TYPE_CLASS', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Active' => 1, 'TypeClass' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'active' => 1, 'typeClass' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ACTIVE => 1, self::TYPE_CLASS => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('ID' => 0, 'ACTIVE' => 1, 'TYPE_CLASS' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new EventTypeMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EventTypePeer::ACTIVE);

		$criteria->addSelectColumn(EventTypePeer::TYPE_CLASS);
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseEventTypePeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseEventTypePeer', $criteria, $con);
    }
  ...
  /**
   * Selects a collection of EventType objects pre-filled with their i18n objects.
   *
  ...
  public static function doSelectWithI18n(Criteria $c, $culture = null, PropelPDO $con = null)
  {
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseEventTypePeer', $c, $con);
    }
    ...
    $c->addJoin(EventTypePeer::ID, EventTypeI18nPeer::ID);
    $c->add(EventTypeI18nPeer::CULTURE, $culture);
    ...
    while($row = $stmt->fetch(PDO::FETCH_NUM)) {
      ...
      $obj1->setEventTypeI18nForCulture($obj2, $culture);
      $obj2->setEventType($obj1);
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return EventTypePeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseEventTypePeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseEventTypePeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseEventTypePeer', $values, $con);
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(EventTypePeer::ID, $criteria->remove(EventTypePeer::ID), $comparison);
    ...
    foreach (sfMixer::getCallables('BaseEventTypePeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseEventTypePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the EMT_EVENT_TYPE table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(EventTypePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof EventType) {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += EventTypePeer::doOnDeleteCascade($criteria, $con);
			...
			// invalidate objects in EventTypeI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related EventTypeI18n objects
			$c = new Criteria(EventTypeI18nPeer::DATABASE_NAME);
			
			$c->add(EventTypeI18nPeer::ID, $obj->getId());
			$affectedRows += EventTypeI18nPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function doValidate(EventType $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(EventTypePeer::DATABASE_NAME, EventTypePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = EventTypePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the EventTypePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the EventTypePeer class:
//
// Propel::getDatabaseMap(EventTypePeer::DATABASE_NAME)->addTableBuilder(EventTypePeer::TABLE_NAME, EventTypePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseEventTypePeer::DATABASE_NAME)->addTableBuilder(BaseEventTypePeer::TABLE_NAME, BaseEventTypePeer::getMapBuilder());
