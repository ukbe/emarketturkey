 ...
 */
require_once(SF_ROOT_DIR.'/config/tcpdf_config.php');
 ...
 * unicode data
 */
require_once(SF_ROOT_DIR.'/config/unicode_data.php');

/**
 * html colors table
 */
require_once(SF_ROOT_DIR.'/config/htmlcolors.php');
	...
	class TCPDF {
		...
		protected function setTableHeader() {
			...
			if (!$this->empty_string($this->thead) AND (!$this->inthead)) {
				...
				// set new top margin to skip the " headers
				if (!isset($this->theadMargins['top'])) {
