 ...
 */
  ...
  {
    sfContext::getInstance()->getResponse()->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype.js');
  ...
  function visual_effect($name, $element_id = false, $js_options = array())
  {
    ...
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype.js');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/builder');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/effects.js');
  ...
  function input_auto_complete_tag($name, $value, $url, $tag_options = array(), $completion_options = array())
  {
    ...
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/prototype.js');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/effects.js');
    $response->addJavascript(sfConfig::get('sf_prototype_web_dir').'/js/controls.js');
